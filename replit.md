...
**Routing**: Wouter.
**Key UI Patterns**: Dashboard-centric, KPI cards, data tables, charts for forecasts, regime status widgets, policy signals panels.
...
**API Design**: RESTful endpoints for authentication, economics, commodity pricing (including real-time for over 110 materials), SKUs, materials, and allocations.
...
**Schema Design**: Multi-tenant schema including `companies`, `users`, `skus`, `materials` (110+ tradeable commodities), `boms`, `suppliers`, `supplier_materials`, `demand_history`, `allocations`, `allocation_results`, and `price_alerts`.
