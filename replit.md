...
- **Durable Stripe Webhook Processing**: webhookHandlers.ts uses stripe_processed_events table instead of in-memory Set. All handlers are replay-safe with idempotency enforced at database level.
