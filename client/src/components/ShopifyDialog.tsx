            ...
            <ScrollArea className="h-[350px] pr-4">
              <div className="space-y-4">
                <div className="rounded-md bg-green-500/10 p-3 text-sm">
                  <p className="font-medium text-good">Connect Your Shopify Store</p>
            ...
            <ScrollArea className="h-[350px] pr-4">
              <div className="space-y-4">
                <div className="rounded-md bg-blue-500/10 p-3 text-sm">
                  <p className="font-medium text-muted-foreground">Webhook Configuration</p>
                  <p className="text-muted-foreground mt-1">
            ...
            <ScrollArea className="h-[350px] pr-4">
              <div className="space-y-4">
                <div className="rounded-md bg-amber-500/10 p-3 text-sm">
                  <p className="font-medium text-signal">Data Sync Options</p>
                  <p className="text-muted-foreground mt-1">
