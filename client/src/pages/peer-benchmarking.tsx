  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold" data-testid="text-page-title">Peer Benchmarking</h1>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t">
                          ...
                          <div>
                            ...
                            <p className="text-lg font-semibold text-green-600" data-testid={`text-savings-${idx}`}>
