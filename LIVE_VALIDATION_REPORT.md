...
**Generated**: 2026-03-29T04:40:26.522Z
...
| 1.4 | automationSafeMode row defaults to safeModeEnabled=1 | runtime | PASS | 6 |
| 1.5 | GET /healthz returns 200 | runtime | PASS | 36 |
...
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 11 |
...
| 3.6 | Rejected draft cannot be executed | runtime | PASS | 9 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 191 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 30 |
...
| 7.9 | Deterministic replay: same seed → identical results | deterministic | PASS | 23 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 30 |
...
| 10.3 | Copilot draft stores evidence bundle with provenanceVer | runtime | PASS | 4 |
...
| 10.7 | Stress test report has configHash (b939eaba9225623b...) | deterministic | PASS | 3 |
...
| 11.16 | Health endpoints all respond within 2000ms (4ms, 6ms, 6 | runtime | PASS | 7 |
...
| 13.3e | Edge-case valid inputs: no NaN in PolicyRecommendation  | deterministic | PASS | 0 |
...
| 13.6a | Cost +40% changes optimization expectedCost: baseline=6 | deterministic | PASS | 32 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 714 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 714 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 715 |
| 13.8d | Heap growth bounded: -0.5 MB < 50 MB over 10000 calls | deterministic | PASS | 715 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (8ab9ff54-db7e | deterministic | PASS | 0 |
...
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=1995804c. | live-db | PASS | 8 |
...
| 17.15 | SNAPSHOT PERSIST: rows=1 decisions=5 winRate=80% | live-db | PASS | 48 |
