...
**Generated**: 2026-03-29T01:12:11.491Z
...
| 2.1 | Materials isolated by companyId — cross-tenant read ret | runtime | PASS | 3 |
...
| 2.4 | Automation rules isolated — cross-tenant read blocked | runtime | PASS | 15 |
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 14 |
| 2.6 | Copilot drafts isolated — Company B has 0 drafts | runtime | PASS | 17 |
| 2.7 | GET /api/materials returns 401/403 for unauthenticated  | runtime | PASS | 2 |
| 2.8 | POST /api/materials returns 401/403 without auth | runtime | PASS | 19 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 200 |
...
| 5.3 | First event insertion succeeds | runtime | PASS | 9 |
...
| 7.5 | Conservative (610) ≤ Aggressive (815) + pack | deterministic | PASS | 28 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 40 |
...
| 10.1 | sanitizeDetails redacts password and apiKey from log pa | runtime | PASS | 1 |
...
| 10.7 | Stress test report has configHash (604743632546e23a...) | deterministic | PASS | 4 |
...
| 11.16 | Health endpoints all respond within 2000ms (4ms, 8ms, 7 | runtime | PASS | 8 |
...
| 12.3 | Savings traceability: schema has measuredOutcomeRef (tr | structural | PASS | 11 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 645 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 646 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 646 |
| 13.8d | Heap growth bounded: -0.4 MB < 50 MB over 10000 calls | deterministic | PASS | 646 |