...
**Generated**: 2026-04-03T02:21:34.058Z
**Harness Version**: 4.0.0
**Verdict**: `SAFE FOR LIMITED PROD`
**Confidence Score**: 100%
**Tests**: 207 PASS / 1 FAIL / 208 total
...
| S13 | Gate 15 — Adversarial + Drift Validation | 31/32 | FAIL |
...
- **[WARN] 13.3d**: Zero/NaN avgDemand throws INSUFFICIENT_DEMAND_DATA: zero=true nan=false

## Full Test Results

| Test ID | Description | Proof | Pass | ms |
|---------|-------------|-------|------|----|
| 1.1 | Database connectivity via SELECT 1 | runtime | PASS | 1 |
| 1.2 | All 10 required tables present in schema | runtime | PASS | 6 |
| 1.3 | DATABASE_URL env var present | structural | PASS | 0 |
| 1.4 | automationSafeMode row defaults to safeModeEnabled=1 | runtime | PASS | 207 |
...
| 2.2 | Suppliers isolated by companyId — cross-tenant read ret | runtime | PASS | 3 |
| 2.3 | SKUs isolated by companyId — cross-tenant read returns  | runtime | PASS | 4 |
| 2.4 | Automation rules isolated — cross-tenant read blocked | runtime | PASS | 428 |
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 308 |
| 2.6 | Copilot drafts isolated — Company B has 0 drafts | runtime | PASS | 165 |
...
| 4.1 | Runtime spend state initialized at 0 | runtime | PASS | 20 |
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 1028 |
...
| 5.3 | First event insertion succeeds | runtime | PASS | 61 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 237 |
| 6.1 | Fast mover WAPE=5.4% < 30% threshold | deterministic | PASS | 1 |
...
| 6.5 | Moving avg WAPE (5.2%) within 5pp of naive (3.4%) | deterministic | PASS | 1 |
...
| 8.4 | Supplier outage scenario present with results | runtime | PASS | 1 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 488 |
| 9.2 | Company A is not blocked by data quality gate | runtime | PASS | 0 |
| 9.3 | Company B quality score (72.0%) is in valid range [0,1] | runtime | PASS | 299 |
...
| 9.7 | Empty company score (0.0%) < Company A (86.0%) — data v | runtime | PASS | 17 |
| 10.1 | sanitizeDetails redacts password and apiKey from log pa | runtime | PASS | 0 |
| 10.2 | Structured event log persists audit entries to DB | runtime | PASS | 20 |
| 10.3 | Copilot draft stores evidence bundle with provenanceVer | runtime | PASS | 9 |
| 10.4 | Optimization evidence bundle has provenanceVersion, opt | deterministic | PASS | 23 |
...
| 10.7 | Stress test report has configHash (d2206838cab4d328...) | deterministic | PASS | 7 |
...
| 12.2 | Cost reality check: max cost drift 5.7% ≤ 20% across 1  | runtime | PASS | 4 |
| 12.3 | Savings traceability: schema has measuredOutcomeRef (tr | structural | PASS | 12 |
...
| 12.5 | Extreme values: optimizedQty=18541 ≤ unboundedLimit=140 | deterministic | PASS | 17 |
...
| 12.9b | computeTrustScore math: perfect=1.0, zero=0.0, mid=0.5  | deterministic | PASS | 1 |
...
| 13.3d | Zero/NaN avgDemand throws INSUFFICIENT_DEMAND_DATA: zer | deterministic | FAIL | 1 |
...
| 13.6a | Cost +40% changes optimization expectedCost: baseline=6 | deterministic | PASS | 36 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 656 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 656 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 656 |
| 13.8d | Heap growth bounded: 0.2 MB < 50 MB over 10000 calls | deterministic | PASS | 656 |
| 14.1a | ACCESS CONTROL: viewer blocked from operator action (AC | deterministic | PASS | 1 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (8ddec3d7-51c5 | deterministic | PASS | 0 |
| 14.6b | DECISION TRACE: timestamp is valid ISO 8601 (2026-04-03 | deterministic | PASS | 0 |
...
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=09080dc9. | live-db | PASS | 10 |
| 17.2 | WIN RATE GLOBAL: 4/5 = 80% (want 80%) | live-db | PASS | 33 |
| 17.3 | WIN RATE BY SKU: SKU-WR-004 (loss) = 0% (want 0%) | live-db | PASS | 35 |
| 17.4 | WIN RATE BY SEGMENT: fast_mover = 66.7% (want 66.7%) | live-db | PASS | 38 |
| 17.5 | WIN RATE BY REGIME: REAL_ECONOMY_LEAD = 100% (want 100% | live-db | PASS | 40 |
| 17.6 | GUARDRAIL <30%: flag=UNDERPERFORMING_SYSTEM blocked=tru | deterministic | PASS | 40 |
| 17.7 | GUARDRAIL <40%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 40 |
| 17.8 | GUARDRAIL <50%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 40 |
| 17.9 | GUARDRAIL ≥50%: flag=null blocked=false multiplier=1 | deterministic | PASS | 40 |
| 17.10 | CONFIDENCE TREND: stable (want "stable" — all outcomes  | live-db | PASS | 43 |
| 17.11 | ADAPTIVE WEIGHTS MAPE=10%: ets=0.9 seasonal=0.08 crosto | deterministic | PASS | 43 |
| 17.12 | ADAPTIVE WEIGHTS MAPE=25%: ets=0.65 seasonal=0.25 crost | deterministic | PASS | 43 |
| 17.13 | ADAPTIVE WEIGHTS MAPE=40%: ets=0.4 seasonal=0.35 crosto | deterministic | PASS | 43 |
| 17.14 | REGIME FACTOR FORMULA: oldFactor=1 acc=0.95 → 1.0050 (e | deterministic | PASS | 43 |
| 17.15 | SNAPSHOT PERSIST: rows=1 decisions=5 winRate=80% | live-db | PASS | 57 |
