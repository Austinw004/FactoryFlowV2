...
**Generated**: 2026-03-22T21:00:26.570Z
**Harness Version**: 2.0.0
**Verdict**: `SAFE FOR PILOT`
**Confidence Score**: 100%
**Tests**: 104 PASS / 0 FAIL / 104 total
...
| 1.2 | All 10 required tables present in schema | runtime | PASS | 13 |
...
| 3.5 | Draft in 'approved' status passes execution gate | runtime | PASS | 5 |
| 3.6 | Rejected draft cannot be executed | runtime | PASS | 6 |
| 3.7 | copilotService: executedAt set only after approved gate | structural | PASS | 1 |
| 4.1 | Runtime spend state initialized at 0 | runtime | PASS | 16 |
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 305 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 72 |
...
| 7.5 | Conservative (610) ≤ Aggressive (815) + pack | deterministic | PASS | 29 |
...
| 8.8 | Aggregate: 2 passed / 4 failed | runtime | PASS | 1 |
...
| 10.7 | Stress test report has configHash (10fdd3a0e8e4e895...) | deterministic | PASS | 5 |
