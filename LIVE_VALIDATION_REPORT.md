...
**Generated**: 2026-03-29T22:51:15.769Z
...
| 1.5 | GET /healthz returns 200 | runtime | PASS | 33 |
| 1.6 | GET /readyz returns 200 | runtime | PASS | 6 |
| 1.7 | GET /livez returns 200 | runtime | PASS | 2 |
| 2.1 | Materials isolated by companyId — cross-tenant read ret | runtime | PASS | 4 |
...
| 2.4 | Automation rules isolated — cross-tenant read blocked | runtime | PASS | 9 |
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 9 |
...
| 2.8 | POST /api/materials returns 401/403 without auth | runtime | PASS | 5 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 272 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 29 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 31 |
| 9.2 | Company A is not blocked by data quality gate | runtime | PASS | 0 |
| 9.3 | Company B quality score (72.0%) is in valid range [0,1] | runtime | PASS | 31 |
...
| 10.3 | Copilot draft stores evidence bundle with provenanceVer | runtime | PASS | 8 |
...
| 10.7 | Stress test report has configHash (7d3ea85a47b1ebb1...) | deterministic | PASS | 4 |
| 11.1 | GET /healthz → 200 (expected: 200) | runtime | PASS | 20 |
| 11.2 | GET /readyz → 200 (expected: 200) | runtime | PASS | 7 |
...
| 11.16 | Health endpoints all respond within 2000ms (4ms, 7ms, 6 | runtime | PASS | 7 |
...
| 12.5 | Extreme values: optimizedQty=18541 ≤ unboundedLimit=140 | deterministic | PASS | 13 |
...
| 12.8 | Counterfactual: baseline=true optimized=true delta=true | deterministic | PASS | 1 |
...
| 13.6b | No non-finite values in optimization output under lowCo | deterministic | PASS | 37 |
| 13.6b | No non-finite values in optimization output under highC | deterministic | PASS | 37 |
| 13.6b | No non-finite values in optimization output under veryL | deterministic | PASS | 37 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 683 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 684 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 684 |
| 13.8d | Heap growth bounded: -0.5 MB < 50 MB over 10000 calls | deterministic | PASS | 684 |
...
| 14.5a | ECONOMIC VALIDITY: NaN field throws INVALID_FIELD_x | deterministic | PASS | 1 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (f41c2397-42a1 | deterministic | PASS | 0 |
...
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=8e704a67. | live-db | PASS | 6 |
| 17.2 | WIN RATE GLOBAL: 4/5 = 80% (want 80%) | live-db | PASS | 26 |
| 17.3 | WIN RATE BY SKU: SKU-WR-004 (loss) = 0% (want 0%) | live-db | PASS | 29 |
| 17.4 | WIN RATE BY SEGMENT: fast_mover = 66.7% (want 66.7%) | live-db | PASS | 30 |
| 17.5 | WIN RATE BY REGIME: REAL_ECONOMY_LEAD = 100% (want 100% | live-db | PASS | 33 |
...
| 17.12 | ADAPTIVE WEIGHTS MAPE=25%: ets=0.65 seasonal=0.25 crost | deterministic | PASS | 35 |
