...
**Generated**: 2026-03-30T03:15:36.325Z
...
| 1.3 | DATABASE_URL env var present | structural | PASS | 1 |
| 1.4 | automationSafeMode row defaults to safeModeEnabled=1 | runtime | PASS | 189 |
...
| 2.4 | Automation rules isolated — cross-tenant read blocked | runtime | PASS | 86 |
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 17 |
...
| 3.3 | Draft in 'draft' status cannot execute — requires appro | runtime | PASS | 14 |
| 3.4 | copilotService enforces 'must be approved' guard (sourc | structural | PASS | 1 |
| 3.5 | Draft in 'approved' status passes execution gate | runtime | PASS | 106 |
| 3.6 | Rejected draft cannot be executed | runtime | PASS | 15 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 653 |
...
| 5.3 | First event insertion succeeds | runtime | PASS | 18 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 53 |
...
| 7.9 | Deterministic replay: same seed → identical results | deterministic | PASS | 26 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 110 |
| 9.2 | Company A is not blocked by data quality gate | runtime | PASS | 0 |
| 9.3 | Company B quality score (72.0%) is in valid range [0,1] | runtime | PASS | 70 |
...
| 9.7 | Empty company score (0.0%) < Company A (86.0%) — data v | runtime | PASS | 19 |
| 10.1 | sanitizeDetails redacts password and apiKey from log pa | runtime | PASS | 0 |
| 10.2 | Structured event log persists audit entries to DB | runtime | PASS | 46 |
| 10.3 | Copilot draft stores evidence bundle with provenanceVer | runtime | PASS | 17 |
| 10.4 | Optimization evidence bundle has provenanceVersion, opt | deterministic | PASS | 13 |
...
| 10.7 | Stress test report has configHash (353113663892dfc9...) | deterministic | PASS | 5 |
...
| 11.4 | GET /api/health → 401 (expected: 200|401|403|302) | runtime | PASS | 9 |
...
| 11.16 | Health endpoints all respond within 2000ms (6ms, 8ms, 8 | runtime | PASS | 10 |
...
| 13.6a | Cost +40% changes optimization expectedCost: baseline=6 | deterministic | PASS | 42 |
| 13.6b | No non-finite values in optimization output under lowCo | deterministic | PASS | 42 |
| 13.6b | No non-finite values in optimization output under highC | deterministic | PASS | 42 |
| 13.6b | No non-finite values in optimization output under veryL | deterministic | PASS | 42 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 774 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 774 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 774 |
| 13.8d | Heap growth bounded: -0.4 MB < 50 MB over 10000 calls | deterministic | PASS | 774 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (bc141197-df55 | deterministic | PASS | 0 |
| 14.6b | DECISION TRACE: timestamp is valid ISO 8601 (2026-03-30 | deterministic | PASS | 1 |
...
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=6f27ebda. | live-db | PASS | 11 |
| 17.2 | WIN RATE GLOBAL: 4/5 = 80% (want 80%) | live-db | PASS | 398 |
| 17.3 | WIN RATE BY SKU: SKU-WR-004 (loss) = 0% (want 0%) | live-db | PASS | 400 |
| 17.4 | WIN RATE BY SEGMENT: fast_mover = 66.7% (want 66.7%) | live-db | PASS | 402 |
| 17.5 | WIN RATE BY REGIME: REAL_ECONOMY_LEAD = 100% (want 100% | live-db | PASS | 405 |
| 17.6 | GUARDRAIL <30%: flag=UNDERPERFORMING_SYSTEM blocked=tru | deterministic | PASS | 405 |
| 17.7 | GUARDRAIL <40%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 405 |
| 17.8 | GUARDRAIL <50%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 405 |
| 17.9 | GUARDRAIL ≥50%: flag=null blocked=false multiplier=1 | deterministic | PASS | 405 |
| 17.10 | CONFIDENCE TREND: stable (want "stable" — all outcomes  | live-db | PASS | 408 |
| 17.11 | ADAPTIVE WEIGHTS MAPE=10%: ets=0.9 seasonal=0.08 crosto | deterministic | PASS | 408 |
| 17.12 | ADAPTIVE WEIGHTS MAPE=25%: ets=0.65 seasonal=0.25 crost | deterministic | PASS | 408 |
| 17.13 | ADAPTIVE WEIGHTS MAPE=40%: ets=0.4 seasonal=0.35 crosto | deterministic | PASS | 408 |
| 17.14 | REGIME FACTOR FORMULA: oldFactor=1 acc=0.95 → 1.0050 (e | deterministic | PASS | 409 |
| 17.15 | SNAPSHOT PERSIST: rows=1 decisions=5 winRate=80% | live-db | PASS | 532 |
