...
**Generated**: 2026-03-29T01:42:06.632Z
**Harness Version**: 2.0.0
**Verdict**: `SAFE FOR PILOT`
**Confidence Score**: 100%
**Tests**: 178 PASS / 0 FAIL / 178 total
...
| 1.5 | GET /healthz returns 200 | runtime | PASS | 53 |
| 1.6 | GET /readyz returns 200 | runtime | PASS | 15 |
| 1.7 | GET /livez returns 200 | runtime | PASS | 4 |
| 2.1 | Materials isolated by companyId — cross-tenant read ret | runtime | PASS | 7 |
...
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 22 |
...
| 2.8 | POST /api/materials returns 401/403 without auth | runtime | PASS | 23 |
...
| 3.3 | Draft in 'draft' status cannot execute — requires appro | runtime | PASS | 10 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 238 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 52 |
...
| 7.1 | Optimized quantity (720) is non-negative | deterministic | PASS | 18 |
...
| 7.5 | Conservative (610) ≤ Aggressive (815) + pack | deterministic | PASS | 32 |
| 7.6 | STRESS regime: qty=940 (non-negative), SL=95.0% | deterministic | PASS | 15 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 28 |
...
| 10.3 | Copilot draft stores evidence bundle with provenanceVer | runtime | PASS | 13 |
...
| 10.6 | Structured event log is tenant-scoped — cross-tenant qu | runtime | PASS | 5 |
| 10.7 | Stress test report has configHash (9334c1d737882908...) | deterministic | PASS | 4 |
| 11.1 | GET /healthz → 200 (expected: 200) | runtime | PASS | 17 |
...
| 12.10c | applyTrustGuard sets automationBlocked=true for trustSc | deterministic | PASS | 1 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 668 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 668 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 669 |
| 13.8d | Heap growth bounded: -0.6 MB < 50 MB over 10000 calls | deterministic | PASS | 669 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (0871fd41-fe92 | deterministic | PASS | 0 |
