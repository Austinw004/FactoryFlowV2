...
**Generated**: 2026-03-29T01:27:19.623Z
**Harness Version**: 2.0.0
**Verdict**: `SAFE FOR PILOT`
**Confidence Score**: 100%
**Tests**: 168 PASS / 0 FAIL / 168 total
...
| 1.5 | GET /healthz returns 200 | runtime | PASS | 39 |
...
| 2.4 | Automation rules isolated — cross-tenant read blocked | runtime | PASS | 8 |
...
| 2.8 | POST /api/materials returns 401/403 without auth | runtime | PASS | 14 |
| 3.1 | Safe mode is enabled (safeModeEnabled=1) for test compa | runtime | PASS | 3 |
| 3.2 | automationEngine.ts enforces safeModeEnabled check (sou | structural | PASS | 2 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 167 |
...
| 9.3 | Company B quality score (72.0%) is in valid range [0,1] | runtime | PASS | 36 |
...
| 10.7 | Stress test report has configHash (a062b61f12118821...) | deterministic | PASS | 4 |
| 11.1 | GET /healthz → 200 (expected: 200) | runtime | PASS | 28 |
...
| 13.6a | Cost +40% changes optimization expectedCost: baseline=6 | deterministic | PASS | 40 |
| 13.6b | No non-finite values in optimization output under lowCo | deterministic | PASS | 40 |
| 13.6b | No non-finite values in optimization output under highC | deterministic | PASS | 40 |
| 13.6b | No non-finite values in optimization output under veryL | deterministic | PASS | 40 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 684 |
...
| 13.8d | Heap growth bounded: -0.6 MB < 50 MB over 10000 calls | deterministic | PASS | 684 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (5ff331d4-13f4 | deterministic | PASS | 0 |
