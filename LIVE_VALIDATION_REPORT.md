...
**Generated**: 2026-03-22T20:35:42.366Z
...
| 1.4 | automationSafeMode row defaults to safeModeEnabled=1 | runtime | PASS | 16 |
...
| 2.4 | Automation rules isolated — cross-tenant read blocked | runtime | PASS | 14 |
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 17 |
| 2.6 | Copilot drafts isolated — Company B has 0 drafts | runtime | PASS | 22 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 45 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 51 |
...
| 10.2 | Structured event log persists audit entries to DB | runtime | PASS | 18 |
...
| 10.7 | Stress test report has configHash (0c57d3027a64c5a5...) | deterministic | PASS | 4 |
...
| 11.16 | Health endpoints all respond within 2000ms (4ms, 7ms, 6 | runtime | PASS | 8 |
