...
**Generated**: 2026-03-29T01:17:16.783Z
...
| 1.5 | GET /healthz returns 200 | runtime | PASS | 46 |
...
| 2.8 | POST /api/materials returns 401/403 without auth | runtime | PASS | 22 |
...
| 3.6 | Rejected draft cannot be executed | runtime | PASS | 5 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 158 |
...
| 5.3 | First event insertion succeeds | runtime | PASS | 78 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 35 |
...
| 7.4 | Qty (720) ≥ MOQ (10) | deterministic | PASS | 1 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 33 |
...
| 10.2 | Structured event log persists audit entries to DB | runtime | PASS | 16 |
...
| 10.7 | Stress test report has configHash (e49eed57a5f34f81...) | deterministic | PASS | 5 |
...
| 11.16 | Health endpoints all respond within 2000ms (4ms, 9ms, 7 | runtime | PASS | 10 |
...
| 12.5 | Extreme values: optimizedQty=18541 ≤ unboundedLimit=140 | deterministic | PASS | 21 |
...
| 13.3e | Edge-case valid inputs: no NaN in PolicyRecommendation  | deterministic | PASS | 2 |
...
| 13.6a | Cost +40% changes optimization expectedCost: baseline=6 | deterministic | PASS | 37 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 242 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 242 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 242 |
| 13.8d | Heap growth bounded: 6.1 MB < 50 MB over 10000 calls | deterministic | PASS | 242 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (2dcaf9ea-a6bb | deterministic | PASS | 0 |
