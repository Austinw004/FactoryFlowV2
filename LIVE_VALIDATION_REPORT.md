...
**Generated**: 2026-03-29T21:33:58.490Z
...
| 1.2 | All 10 required tables present in schema | runtime | PASS | 5 |
| 1.3 | DATABASE_URL env var present | structural | PASS | 0 |
| 1.4 | automationSafeMode row defaults to safeModeEnabled=1 | runtime | PASS | 12 |
...
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 15 |
| 2.6 | Copilot drafts isolated — Company B has 0 drafts | runtime | PASS | 19 |
| 2.7 | GET /api/materials returns 401/403 for unauthenticated  | runtime | PASS | 3 |
| 2.8 | POST /api/materials returns 401/403 without auth | runtime | PASS | 16 |
...
| 4.1 | Runtime spend state initialized at 0 | runtime | PASS | 12 |
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 151 |
...
| 5.4 | Duplicate (companyId+triggerType+triggerEventId) reject | runtime | PASS | 1 |
| 5.5 | onConflictDoNothing: second insert leaves exactly 1 row | runtime | PASS | 4 |
...
| 7.9 | Deterministic replay: same seed → identical results | deterministic | PASS | 20 |
...
| 10.6 | Structured event log is tenant-scoped — cross-tenant qu | runtime | PASS | 1 |
| 10.7 | Stress test report has configHash (855dd0d864921412...) | deterministic | PASS | 3 |
...
| 11.4 | GET /api/health → 401 (expected: 200|401|403|302) | runtime | PASS | 1 |
| 11.5 | GET /api/materials → 401 (expected: 401|403|302) | runtime | PASS | 2 |
| 11.6 | GET /api/skus → 401 (expected: 401|403|302) | runtime | PASS | 3 |
...
| 12.5 | Extreme values: optimizedQty=18541 ≤ unboundedLimit=140 | deterministic | PASS | 19 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 631 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 631 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 631 |
| 13.8d | Heap growth bounded: 0.5 MB < 50 MB over 10000 calls | deterministic | PASS | 631 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (97d4b24e-7fce | deterministic | PASS | 0 |
...
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=9887e73a. | live-db | PASS | 9 |
...
| 17.5 | WIN RATE BY REGIME: REAL_ECONOMY_LEAD = 100% (want 100% | live-db | PASS | 36 |
| 17.6 | GUARDRAIL <30%: flag=UNDERPERFORMING_SYSTEM blocked=tru | deterministic | PASS | 36 |
...
| 17.10 | CONFIDENCE TREND: stable (want "stable" — all outcomes  | live-db | PASS | 38 |
