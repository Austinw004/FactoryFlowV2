...
**Generated**: 2026-03-29T03:25:02.042Z
...
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 8 |
| 2.6 | Copilot drafts isolated — Company B has 0 drafts | runtime | PASS | 8 |
...
| 3.2 | automationEngine.ts enforces safeModeEnabled check (sou | structural | PASS | 0 |
| 3.3 | Draft in 'draft' status cannot execute — requires appro | runtime | PASS | 8 |
...
| 4.1 | Runtime spend state initialized at 0 | runtime | PASS | 7 |
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 198 |
...
| 5.3 | First event insertion succeeds | runtime | PASS | 20 |
| 5.4 | Duplicate (companyId+triggerType+triggerEventId) reject | runtime | PASS | 3 |
| 5.5 | onConflictDoNothing: second insert leaves exactly 1 row | runtime | PASS | 8 |
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 48 |
...
| 7.1 | Optimized quantity (720) is non-negative | deterministic | PASS | 16 |
...
| 7.6 | STRESS regime: qty=940 (non-negative), SL=95.0% | deterministic | PASS | 13 |
...
| 7.9 | Deterministic replay: same seed → identical results | deterministic | PASS | 27 |
| 8.1 | Stress test runs without crash for all 6 default scenar | runtime | PASS | 5 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 37 |
| 9.2 | Company A is not blocked by data quality gate | runtime | PASS | 0 |
| 9.3 | Company B quality score (72.0%) is in valid range [0,1] | runtime | PASS | 34 |
...
| 10.2 | Structured event log persists audit entries to DB | runtime | PASS | 6 |
| 10.3 | Copilot draft stores evidence bundle with provenanceVer | runtime | PASS | 6 |
| 10.4 | Optimization evidence bundle has provenanceVersion, opt | deterministic | PASS | 9 |
| 10.5 | SHA-256 hashing: same config JSON → identical hash (det | deterministic | PASS | 1 |
| 10.6 | Structured event log is tenant-scoped — cross-tenant qu | runtime | PASS | 4 |
| 10.7 | Stress test report has configHash (c08130e34ebf38a2...) | deterministic | PASS | 3 |
...
| 11.14 | POST /api/adaptive-forecast/analyze → 401 (expected: 40 | runtime | PASS | 1 |
| 11.15 | POST /api/stress-test/run → 401 (expected: 401|403|302| | runtime | PASS | 2 |
| 11.16 | Health endpoints all respond within 2000ms (4ms, 6ms, 4 | runtime | PASS | 6 |
...
| 13.6a | Cost +40% changes optimization expectedCost: baseline=6 | deterministic | PASS | 31 |
| 13.6b | No non-finite values in optimization output under lowCo | deterministic | PASS | 32 |
| 13.6b | No non-finite values in optimization output under highC | deterministic | PASS | 32 |
| 13.6b | No non-finite values in optimization output under veryL | deterministic | PASS | 32 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 614 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 614 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 614 |
| 13.8d | Heap growth bounded: -0.3 MB < 50 MB over 10000 calls | deterministic | PASS | 614 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (49feeb1d-93c3 | deterministic | PASS | 1 |
...
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=967903cc. | live-db | PASS | 8 |
| 17.2 | WIN RATE GLOBAL: 4/5 = 80% (want 80%) | live-db | PASS | 31 |
| 17.3 | WIN RATE BY SKU: SKU-WR-004 (loss) = 0% (want 0%) | live-db | PASS | 33 |
| 17.4 | WIN RATE BY SEGMENT: fast_mover = 66.7% (want 66.7%) | live-db | PASS | 35 |
| 17.5 | WIN RATE BY REGIME: REAL_ECONOMY_LEAD = 100% (want 100% | live-db | PASS | 37 |
| 17.6 | GUARDRAIL <30%: flag=UNDERPERFORMING_SYSTEM blocked=tru | deterministic | PASS | 38 |
| 17.7 | GUARDRAIL <40%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 38 |
| 17.8 | GUARDRAIL <50%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 38 |
| 17.9 | GUARDRAIL ≥50%: flag=null blocked=false multiplier=1 | deterministic | PASS | 38 |
| 17.10 | CONFIDENCE TREND: stable (want "stable" — all outcomes  | live-db | PASS | 40 |
| 17.11 | ADAPTIVE WEIGHTS MAPE=10%: ets=0.9 seasonal=0.08 crosto | deterministic | PASS | 40 |
| 17.12 | ADAPTIVE WEIGHTS MAPE=25%: ets=0.65 seasonal=0.25 crost | deterministic | PASS | 41 |
| 17.13 | ADAPTIVE WEIGHTS MAPE=40%: ets=0.4 seasonal=0.35 crosto | deterministic | PASS | 41 |
| 17.14 | REGIME FACTOR FORMULA: oldFactor=1 acc=0.95 → 1.0050 (e | deterministic | PASS | 41 |
| 17.15 | SNAPSHOT PERSIST: rows=1 decisions=5 winRate=80% | live-db | PASS | 52 |
