...
**Generated**: 2026-03-23T02:21:31.485Z
**Harness Version**: 2.0.0
**Verdict**: `SAFE FOR PILOT`
**Confidence Score**: 100%
**Tests**: 136 PASS / 0 FAIL / 136 total
...
| 1.5 | GET /healthz returns 200 | runtime | PASS | 77 |
| 1.6 | GET /readyz returns 200 | runtime | PASS | 17 |
...
| 2.7 | GET /api/materials returns 401/403 for unauthenticated  | runtime | PASS | 5 |
...
| 3.6 | Rejected draft cannot be executed | runtime | PASS | 11 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 263 |
...
| 7.1 | Optimized quantity (720) is non-negative | deterministic | PASS | 28 |
...
| 7.5 | Conservative (610) ≤ Aggressive (815) + pack | deterministic | PASS | 43 |
| 7.6 | STRESS regime: qty=940 (non-negative), SL=95.0% | deterministic | PASS | 16 |
...
| 7.9 | Deterministic replay: same seed → identical results | deterministic | PASS | 30 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 39 |
| 9.2 | Company A is not blocked by data quality gate | runtime | PASS | 0 |
| 9.3 | Company B quality score (72.0%) is in valid range [0,1] | runtime | PASS | 41 |
...
| 10.2 | Structured event log persists audit entries to DB | runtime | PASS | 10 |
| 10.3 | Copilot draft stores evidence bundle with provenanceVer | runtime | PASS | 11 |
| 10.4 | Optimization evidence bundle has provenanceVersion, opt | deterministic | PASS | 17 |
...
| 10.7 | Stress test report has configHash (99abeeffceb1b2bb...) | deterministic | PASS | 8 |
| 11.1 | GET /healthz → 200 (expected: 200) | runtime | PASS | 47 |
| 11.2 | GET /readyz → 200 (expected: 200) | runtime | PASS | 8 |
| 11.3 | GET /livez → 200 (expected: 200) | runtime | PASS | 2 |
| 11.4 | GET /api/health → 401 (expected: 200|401|403|302) | runtime | PASS | 3 |
| 11.5 | GET /api/materials → 401 (expected: 401|403|302) | runtime | PASS | 4 |
| 11.6 | GET /api/skus → 401 (expected: 401|403|302) | runtime | PASS | 4 |
| 11.7 | GET /api/suppliers → 401 (expected: 401|403|302) | runtime | PASS | 3 |
...
| 11.10 | GET /api/forecast-accuracy/metrics → 401 (expected: 401 | runtime | PASS | 3 |
...
| 11.15 | POST /api/stress-test/run → 401 (expected: 401|403|302| | runtime | PASS | 5 |
| 11.16 | Health endpoints all respond within 2000ms (12ms, 32ms, | runtime | PASS | 32 |
| 11.17 | GET /api/does-not-exist-xyz-abc → 401 | runtime | PASS | 3 |
| 12.1 | ERP reconciliation: forecast-vs-actual error ≤50% [fore | runtime | PASS | 5 |
...
| 13.1d | Severe drift: automationBlocked=true driftScore=1.0000 | deterministic | PASS | 2 |
...
| 13.6a | Cost +40% changes optimization expectedCost: baseline=6 | deterministic | PASS | 44 |
| 13.6b | No non-finite values in optimization output under lowCo | deterministic | PASS | 45 |
| 13.6b | No non-finite values in optimization output under highC | deterministic | PASS | 45 |
| 13.6b | No non-finite values in optimization output under veryL | deterministic | PASS | 45 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 190 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 190 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 190 |
| 13.8d | Heap growth bounded: 4.0 MB < 50 MB over 10000 calls | deterministic | PASS | 190 |