...
**Generated**: 2026-03-29T22:42:44.639Z
...
| 1.2 | All 10 required tables present in schema | runtime | PASS | 3 |
| 1.3 | DATABASE_URL env var present | structural | PASS | 0 |
| 1.4 | automationSafeMode row defaults to safeModeEnabled=1 | runtime | PASS | 8 |
| 1.5 | GET /healthz returns 200 | runtime | PASS | 34 |
...
| 2.4 | Automation rules isolated — cross-tenant read blocked | runtime | PASS | 10 |
...
| 2.8 | POST /api/materials returns 401/403 without auth | runtime | PASS | 6 |
...
| 3.5 | Draft in 'approved' status passes execution gate | runtime | PASS | 7 |
| 3.6 | Rejected draft cannot be executed | runtime | PASS | 7 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 161 |
...
| 5.2 | Different payloads produce different event IDs (no coll | deterministic | PASS | 1 |
| 5.3 | First event insertion succeeds | runtime | PASS | 5 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 32 |
...
| 7.1 | Optimized quantity (720) is non-negative | deterministic | PASS | 13 |
...
| 7.5 | Conservative (610) ≤ Aggressive (815) + pack | deterministic | PASS | 26 |
...
| 8.7 | All scenarios include automationDowngrade with downgrad | runtime | PASS | 1 |
...
| 10.7 | Stress test report has configHash (4aebc0dce42506a0...) | deterministic | PASS | 3 |
| 11.1 | GET /healthz → 200 (expected: 200) | runtime | PASS | 7 |
...
| 11.11 | GET /api/multi-horizon-forecasts → 401 (expected: 401|4 | runtime | PASS | 3 |
| 11.12 | GET /api/adaptive-forecast/reports → 401 (expected: 401 | runtime | PASS | 2 |
...
| 11.16 | Health endpoints all respond within 2000ms (4ms, 8ms, 6 | runtime | PASS | 8 |
...
| 12.3 | Savings traceability: schema has measuredOutcomeRef (tr | structural | PASS | 6 |
...
| 12.5 | Extreme values: optimizedQty=18541 ≤ unboundedLimit=140 | deterministic | PASS | 14 |
...
| 13.1d | Severe drift: automationBlocked=true driftScore=1.0000 | deterministic | PASS | 0 |
...
| 13.3a | Negative demand: assertEconomicValidity throws for avgD | deterministic | PASS | 0 |
| 13.3b | Extreme outlier (5000) flagged: isAnomaly=true zScore=1 | deterministic | PASS | 0 |
...
| 13.5a | Worsening error sequence detected as degrading: isDegra | deterministic | PASS | 1 |
| 13.5b | historicalAccuracy declines: early=0.942 late=0.566 | deterministic | PASS | 1 |
| 13.5c | ACCURACY_DEGRADING flag raised on worsening series (fla | deterministic | PASS | 1 |
| 13.5d | trustScore reflects accuracy degradation: good=0.928 de | deterministic | PASS | 1 |
| 13.6a | Cost +40% changes optimization expectedCost: baseline=6 | deterministic | PASS | 33 |
| 13.6b | No non-finite values in optimization output under lowCo | deterministic | PASS | 33 |
| 13.6b | No non-finite values in optimization output under highC | deterministic | PASS | 33 |
| 13.6b | No non-finite values in optimization output under veryL | deterministic | PASS | 33 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 630 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 630 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 630 |
| 13.8d | Heap growth bounded: -0.5 MB < 50 MB over 10000 calls | deterministic | PASS | 630 |
...
| 14.3c | TRUST ENFORCEMENT: trustScore=0.85 → automationBlocked= | deterministic | PASS | 1 |
| 14.3d | TRUST ENFORCEMENT: trustScore=0.4 (boundary) does not t | deterministic | PASS | 1 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (98236d8f-f889 | deterministic | PASS | 0 |
| 14.6b | DECISION TRACE: timestamp is valid ISO 8601 (2026-03-29 | deterministic | PASS | 1 |
...
| 16.2 | OUTCOME: service improvement → win=true winType=service | deterministic | PASS | 0 |
| 16.3 | OUTCOME: stockout reduction → win=true winType=stockout | deterministic | PASS | 0 |
| 16.4 | OUTCOME: two improvements → compound (got compound) | deterministic | PASS | 0 |
| 16.5 | OUTCOME: all three improvements → compound (deltaCost=- | deterministic | PASS | 0 |
| 16.6 | OUTCOME: all worse → win=false winType=no_win | deterministic | PASS | 0 |
| 16.7 | OUTCOME: identical actual vs baseline → win=false winTy | deterministic | PASS | 0 |
| 16.8 | OUTCOME: NaN baseline.cost throws INVALID_OUTCOME_FIELD | deterministic | PASS | 0 |
| 16.9 | OUTCOME: serviceLevel=1.5 throws INVALID_OUTCOME_FIELD  | deterministic | PASS | 0 |
| 16.10 | OUTCOME: Infinity actual.cost throws INVALID_OUTCOME_FI | deterministic | PASS | 1 |
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=0fa7fdd1. | live-db | PASS | 7 |
| 17.2 | WIN RATE GLOBAL: 4/5 = 80% (want 80%) | live-db | PASS | 26 |
| 17.3 | WIN RATE BY SKU: SKU-WR-004 (loss) = 0% (want 0%) | live-db | PASS | 28 |
| 17.4 | WIN RATE BY SEGMENT: fast_mover = 66.7% (want 66.7%) | live-db | PASS | 30 |
| 17.5 | WIN RATE BY REGIME: REAL_ECONOMY_LEAD = 100% (want 100% | live-db | PASS | 32 |
| 17.6 | GUARDRAIL <30%: flag=UNDERPERFORMING_SYSTEM blocked=tru | deterministic | PASS | 33 |
| 17.7 | GUARDRAIL <40%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 33 |
| 17.8 | GUARDRAIL <50%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 33 |
| 17.9 | GUARDRAIL ≥50%: flag=null blocked=false multiplier=1 | deterministic | PASS | 33 |
| 17.10 | CONFIDENCE TREND: stable (want "stable" — all outcomes  | live-db | PASS | 35 |
| 17.11 | ADAPTIVE WEIGHTS MAPE=10%: ets=0.9 seasonal=0.08 crosto | deterministic | PASS | 35 |
| 17.12 | ADAPTIVE WEIGHTS MAPE=25%: ets=0.65 seasonal=0.25 crost | deterministic | PASS | 36 |
| 17.13 | ADAPTIVE WEIGHTS MAPE=40%: ets=0.4 seasonal=0.35 crosto | deterministic | PASS | 36 |
| 17.14 | REGIME FACTOR FORMULA: oldFactor=1 acc=0.95 → 1.0050 (e | deterministic | PASS | 36 |
| 17.15 | SNAPSHOT PERSIST: rows=1 decisions=5 winRate=80% | live-db | PASS | 45 |
...
| 18.11 | enrichNewsItem detects negative sentiment for disruptio | deterministic | PASS | 1 |
