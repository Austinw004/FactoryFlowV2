...
**Generated**: 2026-03-29T01:33:03.306Z
...
| 1.5 | GET /healthz returns 200 | runtime | PASS | 54 |
| 1.6 | GET /readyz returns 200 | runtime | PASS | 11 |
| 1.7 | GET /livez returns 200 | runtime | PASS | 4 |
| 2.1 | Materials isolated by companyId — cross-tenant read ret | runtime | PASS | 7 |
| 2.2 | Suppliers isolated by companyId — cross-tenant read ret | runtime | PASS | 7 |
...
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 14 |
| 2.6 | Copilot drafts isolated — Company B has 0 drafts | runtime | PASS | 124 |
...
| 3.1 | Safe mode is enabled (safeModeEnabled=1) for test compa | runtime | PASS | 4 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 273 |
...
| 5.4 | Duplicate (companyId+triggerType+triggerEventId) reject | runtime | PASS | 15 |
| 5.5 | onConflictDoNothing: second insert leaves exactly 1 row | runtime | PASS | 19 |
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 68 |
...
| 6.6 | Bias=0.39% within ±10% threshold | deterministic | PASS | 1 |
...
| 7.1 | Optimized quantity (720) is non-negative | deterministic | PASS | 22 |
...
| 7.5 | Conservative (610) ≤ Aggressive (815) + pack | deterministic | PASS | 44 |
...
| 7.9 | Deterministic replay: same seed → identical results | deterministic | PASS | 38 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 77 |
...
| 10.2 | Structured event log persists audit entries to DB | runtime | PASS | 17 |
| 10.3 | Copilot draft stores evidence bundle with provenanceVer | runtime | PASS | 7 |
| 10.4 | Optimization evidence bundle has provenanceVersion, opt | deterministic | PASS | 15 |
...
| 10.7 | Stress test report has configHash (5a770616781655bc...) | deterministic | PASS | 4 |
| 11.1 | GET /healthz → 200 (expected: 200) | runtime | PASS | 18 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 644 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 644 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 644 |
| 13.8d | Heap growth bounded: -0.4 MB < 50 MB over 10000 calls | deterministic | PASS | 644 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (adf8d64c-6847 | deterministic | PASS | 0 |
