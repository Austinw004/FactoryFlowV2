...
**Generated**: 2026-03-21T21:11:21.149Z
...
| 1.5 | GET /healthz returns 200 | runtime | PASS | 55 |
...
| 3.1 | Safe mode is enabled (safeModeEnabled=1) for test compa | runtime | PASS | 1 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 208 |
...
| 5.3 | First event insertion succeeds | runtime | PASS | 11 |
...
| 9.3 | Company B quality score (72.0%) is in valid range [0,1] | runtime | PASS | 47 |
...
| 9.7 | Empty company score (0.0%) < Company A (86.0%) — data v | runtime | PASS | 14 |
| 10.1 | sanitizeDetails redacts password and apiKey from log pa | runtime | PASS | 1 |
| 10.2 | Structured event log persists audit entries to DB | runtime | PASS | 14 |
...
| 10.7 | Stress test report has configHash (585a812abb4b2d2f...) | deterministic | PASS | 4 |
