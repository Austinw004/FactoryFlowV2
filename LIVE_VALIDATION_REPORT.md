...
**Generated**: 2026-03-29T04:50:58.822Z
...
| 1.4 | automationSafeMode row defaults to safeModeEnabled=1 | runtime | PASS | 10 |
| 1.5 | GET /healthz returns 200 | runtime | PASS | 38 |
| 1.6 | GET /readyz returns 200 | runtime | PASS | 9 |
...
| 2.3 | SKUs isolated by companyId — cross-tenant read returns  | runtime | PASS | 6 |
| 2.4 | Automation rules isolated — cross-tenant read blocked | runtime | PASS | 11 |
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 13 |
| 2.6 | Copilot drafts isolated — Company B has 0 drafts | runtime | PASS | 15 |
| 2.7 | GET /api/materials returns 401/403 for unauthenticated  | runtime | PASS | 3 |
| 2.8 | POST /api/materials returns 401/403 without auth | runtime | PASS | 13 |
...
| 3.5 | Draft in 'approved' status passes execution gate | runtime | PASS | 11 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 396 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 39 |
...
| 7.5 | Conservative (610) ≤ Aggressive (815) + pack | deterministic | PASS | 30 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 45 |
| 9.2 | Company A is not blocked by data quality gate | runtime | PASS | 0 |
| 9.3 | Company B quality score (72.0%) is in valid range [0,1] | runtime | PASS | 39 |
...
| 10.7 | Stress test report has configHash (f9257846afbb5590...) | deterministic | PASS | 3 |
...
| 11.14 | POST /api/adaptive-forecast/analyze → 401 (expected: 40 | runtime | PASS | 3 |
| 11.15 | POST /api/stress-test/run → 401 (expected: 401|403|302| | runtime | PASS | 2 |
| 11.16 | Health endpoints all respond within 2000ms (4ms, 7ms, 5 | runtime | PASS | 7 |
...
| 12.5 | Extreme values: optimizedQty=18541 ≤ unboundedLimit=140 | deterministic | PASS | 11 |
...
| 12.9 | Trust score present: policy=0.849 optimization=0.938 | deterministic | PASS | 6 |
...
| 13.3c | Non-finite inputs throw SAFETY_VIOLATION: Infinity=true | deterministic | PASS | 0 |
| 13.3d | Zero/NaN avgDemand throws INSUFFICIENT_DEMAND_DATA: zer | deterministic | PASS | 0 |
...
| 13.6b | No non-finite values in optimization output under highC | deterministic | PASS | 34 |
| 13.6b | No non-finite values in optimization output under veryL | deterministic | PASS | 34 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 766 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 766 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 766 |
| 13.8d | Heap growth bounded: -0.5 MB < 50 MB over 10000 calls | deterministic | PASS | 766 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (16aa7705-c2c9 | deterministic | PASS | 0 |
...
| 16.10 | OUTCOME: Infinity actual.cost throws INVALID_OUTCOME_FI | deterministic | PASS | 0 |
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=43f4c52a. | live-db | PASS | 9 |
| 17.2 | WIN RATE GLOBAL: 4/5 = 80% (want 80%) | live-db | PASS | 36 |
| 17.3 | WIN RATE BY SKU: SKU-WR-004 (loss) = 0% (want 0%) | live-db | PASS | 38 |
| 17.4 | WIN RATE BY SEGMENT: fast_mover = 66.7% (want 66.7%) | live-db | PASS | 41 |
| 17.5 | WIN RATE BY REGIME: REAL_ECONOMY_LEAD = 100% (want 100% | live-db | PASS | 42 |
| 17.6 | GUARDRAIL <30%: flag=UNDERPERFORMING_SYSTEM blocked=tru | deterministic | PASS | 42 |
| 17.7 | GUARDRAIL <40%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 42 |
| 17.8 | GUARDRAIL <50%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 42 |
| 17.9 | GUARDRAIL ≥50%: flag=null blocked=false multiplier=1 | deterministic | PASS | 42 |
| 17.10 | CONFIDENCE TREND: stable (want "stable" — all outcomes  | live-db | PASS | 45 |
| 17.11 | ADAPTIVE WEIGHTS MAPE=10%: ets=0.9 seasonal=0.08 crosto | deterministic | PASS | 45 |
| 17.12 | ADAPTIVE WEIGHTS MAPE=25%: ets=0.65 seasonal=0.25 crost | deterministic | PASS | 45 |
| 17.13 | ADAPTIVE WEIGHTS MAPE=40%: ets=0.4 seasonal=0.35 crosto | deterministic | PASS | 45 |
| 17.14 | REGIME FACTOR FORMULA: oldFactor=1 acc=0.95 → 1.0050 (e | deterministic | PASS | 45 |
| 17.15 | SNAPSHOT PERSIST: rows=1 decisions=5 winRate=80% | live-db | PASS | 54 |
