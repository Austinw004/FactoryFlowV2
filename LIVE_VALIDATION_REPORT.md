...
**Generated**: 2026-03-29T23:03:10.629Z
...
| 2.6 | Copilot drafts isolated — Company B has 0 drafts | runtime | PASS | 11 |
...
| 3.6 | Rejected draft cannot be executed | runtime | PASS | 20 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 213 |
...
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 31 |
...
| 9.7 | Empty company score (0.0%) < Company A (86.0%) — data v | runtime | PASS | 10 |
| 10.1 | sanitizeDetails redacts password and apiKey from log pa | runtime | PASS | 0 |
| 10.2 | Structured event log persists audit entries to DB | runtime | PASS | 32 |
...
| 10.7 | Stress test report has configHash (7d86c9b6269c31a0...) | deterministic | PASS | 4 |
...
| 11.4 | GET /api/health → 401 (expected: 200|401|403|302) | runtime | PASS | 3 |
...
| 11.8 | GET /api/rfqs → 401 (expected: 401|403|302) | runtime | PASS | 3 |
...
| 12.1 | ERP reconciliation: forecast-vs-actual error ≤50% [fore | runtime | PASS | 2 |
| 12.2 | Cost reality check: max cost drift 5.7% ≤ 20% across 1  | runtime | PASS | 1 |
| 12.3 | Savings traceability: schema has measuredOutcomeRef (tr | structural | PASS | 8 |
...
| 12.5 | Extreme values: optimizedQty=18541 ≤ unboundedLimit=140 | deterministic | PASS | 12 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 677 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 677 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 678 |
| 13.8d | Heap growth bounded: -0.6 MB < 50 MB over 10000 calls | deterministic | PASS | 678 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (f19e45cd-fb16 | deterministic | PASS | 0 |
...
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=8ebc015b. | live-db | PASS | 17 |
| 17.2 | WIN RATE GLOBAL: 4/5 = 80% (want 80%) | live-db | PASS | 40 |
| 17.3 | WIN RATE BY SKU: SKU-WR-004 (loss) = 0% (want 0%) | live-db | PASS | 42 |
| 17.4 | WIN RATE BY SEGMENT: fast_mover = 66.7% (want 66.7%) | live-db | PASS | 45 |
| 17.5 | WIN RATE BY REGIME: REAL_ECONOMY_LEAD = 100% (want 100% | live-db | PASS | 47 |
| 17.6 | GUARDRAIL <30%: flag=UNDERPERFORMING_SYSTEM blocked=tru | deterministic | PASS | 47 |
| 17.7 | GUARDRAIL <40%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 47 |
| 17.8 | GUARDRAIL <50%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 47 |
| 17.9 | GUARDRAIL ≥50%: flag=null blocked=false multiplier=1 | deterministic | PASS | 47 |
| 17.10 | CONFIDENCE TREND: stable (want "stable" — all outcomes  | live-db | PASS | 50 |
| 17.11 | ADAPTIVE WEIGHTS MAPE=10%: ets=0.9 seasonal=0.08 crosto | deterministic | PASS | 50 |
| 17.12 | ADAPTIVE WEIGHTS MAPE=25%: ets=0.65 seasonal=0.25 crost | deterministic | PASS | 50 |
| 17.13 | ADAPTIVE WEIGHTS MAPE=40%: ets=0.4 seasonal=0.35 crosto | deterministic | PASS | 50 |
| 17.14 | REGIME FACTOR FORMULA: oldFactor=1 acc=0.95 → 1.0050 (e | deterministic | PASS | 50 |
| 17.15 | SNAPSHOT PERSIST: rows=1 decisions=5 winRate=80% | live-db | PASS | 62 |
...
| 18.12 | enrichNewsItem sets provenance="RSS_V1" (got: RSS_V1) | deterministic | PASS | 1 |
