...
**Generated**: 2026-03-29T21:38:42.016Z
...
| 1.5 | GET /healthz returns 200 | runtime | PASS | 37 |
...
| 2.6 | Copilot drafts isolated — Company B has 0 drafts | runtime | PASS | 12 |
...
| 3.6 | Rejected draft cannot be executed | runtime | PASS | 8 |
...
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 214 |
...
| 7.5 | Conservative (610) ≤ Aggressive (815) + pack | deterministic | PASS | 41 |
...
| 7.9 | Deterministic replay: same seed → identical results | deterministic | PASS | 29 |
| 8.1 | Stress test runs without crash for all 6 default scenar | runtime | PASS | 6 |
| 8.2 | All 6 default stress scenarios executed (found 6) | runtime | PASS | 1 |
...
| 8.9 | Stress report configHash is deterministic across runs | deterministic | PASS | 4 |
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 35 |
| 9.2 | Company A is not blocked by data quality gate | runtime | PASS | 0 |
| 9.3 | Company B quality score (72.0%) is in valid range [0,1] | runtime | PASS | 38 |
...
| 9.7 | Empty company score (0.0%) < Company A (86.0%) — data v | runtime | PASS | 13 |
...
| 10.7 | Stress test report has configHash (846bb7261fb0b291...) | deterministic | PASS | 5 |
...
| 13.6b | No non-finite values in optimization output under lowCo | deterministic | PASS | 34 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 658 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 658 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 658 |
| 13.8d | Heap growth bounded: -0.5 MB < 50 MB over 10000 calls | deterministic | PASS | 658 |
...
| 14.4a | EVIDENCE: empty entityIds throws MISSING_EVIDENCE | deterministic | PASS | 1 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (5ef1b5bb-d331 | deterministic | PASS | 0 |
...
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=847f5654. | live-db | PASS | 7 |
| 17.2 | WIN RATE GLOBAL: 4/5 = 80% (want 80%) | live-db | PASS | 29 |
| 17.3 | WIN RATE BY SKU: SKU-WR-004 (loss) = 0% (want 0%) | live-db | PASS | 31 |
| 17.4 | WIN RATE BY SEGMENT: fast_mover = 66.7% (want 66.7%) | live-db | PASS | 34 |
...
| 17.7 | GUARDRAIL <40%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 37 |
| 17.8 | GUARDRAIL <50%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 37 |
| 17.9 | GUARDRAIL ≥50%: flag=null blocked=false multiplier=1 | deterministic | PASS | 37 |
