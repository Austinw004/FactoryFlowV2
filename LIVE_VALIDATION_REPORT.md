...
**Generated**: 2026-03-29T22:21:37.967Z
...
| 2.5 | Purchase orders isolated — cross-tenant read blocked | runtime | PASS | 27 |
| 2.6 | Copilot drafts isolated — Company B has 0 drafts | runtime | PASS | 111 |
...
| 4.1 | Runtime spend state initialized at 0 | runtime | PASS | 15 |
| 4.2 | Atomic UPDATE prevents overspend: finalSpend=9900 ≤ lim | runtime | PASS | 190 |
...
| 5.3 | First event insertion succeeds | runtime | PASS | 10 |
| 5.4 | Duplicate (companyId+triggerType+triggerEventId) reject | runtime | PASS | 3 |
| 5.5 | onConflictDoNothing: second insert leaves exactly 1 row | runtime | PASS | 9 |
| 5.6 | 50 concurrent duplicate inserts → exactly 1 row in DB | runtime | PASS | 77 |
...
| 7.1 | Optimized quantity (720) is non-negative | deterministic | PASS | 23 |
...
| 7.5 | Conservative (610) ≤ Aggressive (815) + pack | deterministic | PASS | 59 |
...
| 8.1 | Stress test runs without crash for all 6 default scenar | runtime | PASS | 6 |
...
| 9.1 | Company A quality score: 86.0% | runtime | PASS | 67 |
| 9.2 | Company A is not blocked by data quality gate | runtime | PASS | 0 |
| 9.3 | Company B quality score (72.0%) is in valid range [0,1] | runtime | PASS | 29 |
...
| 9.7 | Empty company score (0.0%) < Company A (86.0%) — data v | runtime | PASS | 15 |
| 10.1 | sanitizeDetails redacts password and apiKey from log pa | runtime | PASS | 0 |
| 10.2 | Structured event log persists audit entries to DB | runtime | PASS | 15 |
...
| 10.7 | Stress test report has configHash (0624268e97ee427a...) | deterministic | PASS | 4 |
...
| 12.3 | Savings traceability: schema has measuredOutcomeRef (tr | structural | PASS | 9 |
...
| 13.8a | 10000 sequential decisions: 0 errors (got 0) | deterministic | PASS | 686 |
| 13.8b | 10000 sequential decisions: 0 NaN outputs (got 0) | deterministic | PASS | 686 |
| 13.8c | Final result valid after 10000 decisions: confidence=0. | deterministic | PASS | 686 |
| 13.8d | Heap growth bounded: 0.5 MB < 50 MB over 10000 calls | deterministic | PASS | 686 |
...
| 14.6a | DECISION TRACE: traceId is valid UUID v4 (b41cafef-b86c | deterministic | PASS | 0 |
...
| 17.1 | OUTCOME PERSIST: win=true winType=compound id=09b8ba11. | live-db | PASS | 9 |
| 17.2 | WIN RATE GLOBAL: 4/5 = 80% (want 80%) | live-db | PASS | 34 |
| 17.3 | WIN RATE BY SKU: SKU-WR-004 (loss) = 0% (want 0%) | live-db | PASS | 37 |
| 17.4 | WIN RATE BY SEGMENT: fast_mover = 66.7% (want 66.7%) | live-db | PASS | 41 |
| 17.5 | WIN RATE BY REGIME: REAL_ECONOMY_LEAD = 100% (want 100% | live-db | PASS | 43 |
...
| 17.8 | GUARDRAIL <50%: flag=UNDERPERFORMING_SYSTEM blocked=fal | deterministic | PASS | 44 |
| 17.9 | GUARDRAIL ≥50%: flag=null blocked=false multiplier=1 | deterministic | PASS | 44 |
...
| 17.14 | REGIME FACTOR FORMULA: oldFactor=1 acc=0.95 → 1.0050 (e | deterministic | PASS | 47 |
